  ...
  stages {
    ...
    stage('Build') {
      steps {
        ...
        sh 'docker tag anyname-webapp:latest docker.cicd-jfrog.domain.co.id:443/anyname-webapp:latest'
      }
    }
    stage('Put into artifact') {
      steps {
        ...
        sh 'docker push docker.cicd-jfrog.domain.co.id:443/anyname-webapp:latest'
      }
    }
  }
}
