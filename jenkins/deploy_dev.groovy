  ...
  stages {
    ...
    stage('Promote') {
      steps {
        ...
        sh 'docker tag klop-webapp:latest docker-registry-default.dcore-dev.telkomsel.co.id:443/dev-dmp/klop-webapp:latest'
      }
    }
    stage('Deploy') {
      steps {
        ...
        sh 'oc project dev-dmp'
        sh 'docker push docker-registry-default.dcore-dev.telkomsel.co.id:443/dev-dmp/klop-webapp:latest'
