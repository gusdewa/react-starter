  ...
  stages {
    ...
    stage('Promote') {
      steps {
        ...
        sh 'docker tag anyname-webapp:latest docker-registry-default.dcore-dev.petrosea.co.id:443/dev-dmp/anyname-webapp:latest'
      }
    }
    stage('Deploy') {
      steps {
        ...
        sh 'oc project dev-dmp'
        sh 'docker push docker-registry-default.dcore-dev.petrosea.co.id:443/dev-dmp/anyname-webapp:latest'
